...
var Electronic = require("./electronics.model");
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(Electronic.find());
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(Electronic.findOneAndDelete({
            id: req.body.id,
            name: req.body.name
          }));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 3;
          _context3.next = 6;
          return regeneratorRuntime.awrap(Electronic.create({
            id: s[0],
            name: s[1],
            quantity: s[2],
            defaultImage: s[3],
...
module.exports = app;
//# sourceMappingURL=electronics.router.dev.js.map
